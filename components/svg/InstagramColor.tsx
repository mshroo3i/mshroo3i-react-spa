export function InstagramColoredIcon(props: any) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 551.034 551.034" enableBackground="new 0 0 551.034 551.034" xmlSpace="preserve" {...props}>
      <linearGradient id="a" gradientUnits="userSpaceOnUse" x1="275.517" y1="4.571" x2="275.517" y2="549.72"
      ...
      <linearGradient id="b" gradientUnits="userSpaceOnUse" x1="275.517" y1="4.571" x2="275.517" y2="549.72"
        gradientTransform="matrix(1 0 0 -1 0 554)">
        <stop offset="0" stopColor="#e09b3d" />
        <stop offset=".3" stopColor="#c74c4d" />
        <stop offset=".6" stopColor="#c21975" />
      ...
      <linearGradient id="c" gradientUnits="userSpaceOnUse" x1="418.306" y1="4.571" x2="418.306" y2="549.72"
        gradientTransform="matrix(1 0 0 -1 0 554)">
        <stop offset="0" stopColor="#e09b3d" />
        <stop offset=".3" stopColor="#c74c4d" />
        <stop offset=".6" stopColor="#c21975" />
      ...
      <circle fill="url(#c)" cx="418.306" cy="134.072" r="34.149" />
    </svg>
  )
}